    ...
    <div className='section--padding'>
      ...
      <div className='teams'>
        <div className='team--member'>
          ...
          <p className='team--member--name'>Kathryn Murphy</p>
          <p className='team--member--title'>Co-Founder</p>
        ...
        <div className='team--member'>
          ...
          <p className='team--member--name'>Brooklyn Simmons</p>
        ...
        <div className='team--member'>
          ...
          <p className='team--member--name'>Floyd Miles</p>
          <p className='team--member--title'>Founder</p>
          <div className='socials'>
            <Link href={'/'}>
              <SlSocialTwitter/>
        ...
        <div className='team--member'>
          ...
          <p className='team--member--name'>Ronald Richards</p>
          <p className='team--member--title'>Co-Founder</p>
          <div className='socials'>
            <Link href={'/'}>
              <SlSocialTwitter/>
